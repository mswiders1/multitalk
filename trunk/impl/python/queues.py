...
dircoll=collections.namedtuple('CORE_MSG_TYPE', ('BROADCAST_END', 'BROADCAST_BEGIN', 'BROADCAST_PROGRESS'))
CORE_MSG_TYPE=dircoll('BROADCAST_END','BROADCAST_BEGIN','BROADCAST_PROGRESS')
